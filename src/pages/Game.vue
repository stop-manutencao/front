<template>
  <main>
    ...
    >
      ...
      <button
        v-bind:class="[
          globalContrastVariable.applyContrast ? 'btnStop-contrast' : 'btnStop',
        ]"
        v-if="allAnswered"
        @click="stopGame()"
      >
      ...
      <button
        class="btn"
        v-bind:class="[
          globalContrastVariable.applyContrast ? 'back-contrast' : 'back',
        ]"
        @click="exitGame"
      >
        Sair
...
.VueCarousel-wrapper {
  box-shadow: 0 0 5vh #00000045 !important;
}
